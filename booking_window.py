...
class Confirm:
    def __init__(self, parent, booking):
        ...
        PNA_seats_amount = int(self.booking.PNA_seats_spinbox.get())
        PNA_beds_amount = int(self.booking.PNA_beds_spinbox.get())
        APN_seats_amount = int(self.booking.APN_seats_spinbox.get())
        APN_beds_amount = int(self.booking.APN_beds_spinbox.get())
        ...
        # name (row 2)
        self.name_label = Label(self.confirm_frame, bg=blue, fg=white, text=f"Name: {name}", font="Helvetica 14", anchor="w", highlightthickness=2, highlightbackground=white, relief="flat", padx=12, pady=5)
        self.name_label.grid(row=2, padx=20, pady=5, sticky="ew")

        # number (row 3)
        self.number_label = Label(self.confirm_frame, bg=blue, fg=white, text=f"Number: {number}", font="Helvetica 14", anchor="w", highlightthickness=2, highlightbackground=white, relief="flat", padx=12, pady=5)
        ...
        self.PNA_frame.grid(row=4, padx=20, pady=20, columnspan=7, sticky="ew")
